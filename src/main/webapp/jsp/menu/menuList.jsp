...
<body class="layui-layout-body " style="overflow: auto">
	...
	<div class="layui-btn-group TableTools" style="margin-left: 10px">
			<button class="layui-btn" id="addMenu">添加模块</button>
			<button class="layui-btn" id="editMenu">编辑模块</button>
			<button class="layui-btn layui-btn-danger" id="delMenu">删除模块</button>
		<button class="layui-btn layui-btn-primary">（不选中为添加顶级模块，选中添加子模块）</button>
	</div>
	<div>
